 ...
 * 코드길이 : 2,382 B
 * 소요시간 : 1H + 강의
 * 비트마스크를 이용해서 방문 처리를 체크한다는 점이 새로웠다. 확실히 유용하고 좋은 방법인 것 같다. 비트마스크를 잘 사용할 수 있도록 연습을 많이 해야겠다.
...
public class Main_B_1194_달이차오른다가자 {
	...
	private static int bfs() {
		while (!queue.isEmpty()) {
            ...
            || maze[curX][curY] == '#' || visited[curX][curY][key])
					continue;
